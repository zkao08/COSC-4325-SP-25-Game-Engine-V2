...
### AudioTest.exe
Runs a suite of audio-related tests.
...
### GameEngine.exe
Runs the runtime version of the game engine.
- A runtime game window should open
- No default level is loaded

### InputTest.exe
Runs a command line-based test for input processing and DirectX integration.
...
### PhysicsTest.exe
Runs a physics simulation test.
...
### LevelEditor.exe
Runs the level editor version of the game engine.
